"""
ui/pages/record_harvest.py
==========================
Вкладка: Реєстрація врожаю

Форма для внесення нового вимірювання врожайності для будь-якого
активного сорту, регіону та сезону.
"""
